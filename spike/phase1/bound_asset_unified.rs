...
const LCKP_TYPE_HASH: [u8;32] = [105,180,67,198,253,53,197,162,136,219,0,246,229,138,127,172,13,54,167,239,77,30,207,77,161,109,140,228,107,170,162,171];
...
fn program_entry()->i8{
    ...
    if args.len() < 56 { return 30; }
    let seal_policy = &args[0..28];
    let lock_addr = &args[28..56];
